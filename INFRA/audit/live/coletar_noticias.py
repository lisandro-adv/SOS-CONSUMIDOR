...
FONTES_RSS = {
    ...
    # Buscas editoriais temáticas. O link de cada item continua apontando
    # para a matéria original; a fonte agregadora é identificada no cadastro.
    'Google Notícias - fontes diversas': {
        'fonte_id': 185,
        'feeds': [
            'https://news.google.com/rss/search?q=(bets+OR+apostas+OR+apostas+esportivas)+Brasil&hl=pt-BR&gl=BR&ceid=BR:pt-419',
            'https://news.google.com/rss/search?q=(endividamento+OR+superendividamento+OR+renegociacao+de+dividas)+Brasil&hl=pt-BR&gl=BR&ceid=BR:pt-419',
            'https://news.google.com/rss/search?q=(juros+abusivos+OR+cartao+de+credito+OR+emprestimo)+Brasil&hl=pt-BR&gl=BR&ceid=BR:pt-419',
            'https://news.google.com/rss/search?q=(golpe+OR+fraude+OR+pix+OR+falso+boleto)+consumidor+Brasil&hl=pt-BR&gl=BR&ceid=BR:pt-419',
            'https://news.google.com/rss/search?q=(inflacao+OR+precos+OR+custo+de+vida+OR+impostos)+brasileiro&hl=pt-BR&gl=BR&ceid=BR:pt-419',
        ]
    },
}
...
PALAVRAS_INTERESSE = [
    ...
    'bets', 'bet', 'apostas', 'aposta esportiva', 'jogo online',
    'vicio em apostas', 'endividamento', 'superendividamento',
    'juros abusivos', 'juros do rotativo', 'renegociacao de divida',
    'fraude bancaria', 'golpe do boleto', 'golpe do whatsapp',
    'custo de vida', 'preco dos alimentos', 'aumento de imposto',
...
def calcular_score_relevancia(titulo, resumo=''):
    ...
    peso_alto = [
        ...
        'bets', 'apostas esportivas', 'jogo online',
    ]
    ...
    peso_medio_alto = [
        ...
        'vicio em apostas', 'endividamento por apostas',
    ]
    ...
    peso_medio = [
        ...
        'endividamento', 'superendividamento', 'renegociacao de divida',
        'juros abusivos', 'juros do rotativo', 'golpe do whatsapp',
        'golpe do boleto', 'preco dos alimentos', 'aumento de imposto',
    ]
